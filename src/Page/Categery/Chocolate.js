...
import FilterByPrice from '../../componets/Filter/Filter';
import VanillaFilter from "../../componets/DropdownOption/Categeryfilter";
const chocolate = () => {
  return (
    <>
     
      <div className="containergrid popularproducts ">
        <div className="flex justify-end space-x-0 mb-0 ms-3">
          <a className="text-gray-600">Chocolate's Cake</a>
        </div>
        <div className="flex justify-end space-x-4 mb-0">
